...
const int BUS_WAIT_TIME = 6;
const int BUS_LEAVING_TIME = 0;
const int BUS_MOVING_TIME = 2;
...
namespace graph {
    ...
    struct route_settings {
        double bus_wait_time=BUS_WAIT_TIME;
        double bus_velocity=BUS_MOVING_TIME;
        double bus_leaving_time = BUS_LEAVING_TIME;
    };
